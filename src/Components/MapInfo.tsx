...
const MapInfo: React.FC<Props> = ({ selectedDate, distance, lastPosition, region }) => (
  <View>
      ...
      <View style={styles.infoView}>
        ...
        <View style={{ minWidth: '50%' }}>
          <View style={styles.content}>
            ...
            <Text style={styles.contentText}>{lastPosition.longitude.toFixed(5)}</Text>
          </View>
          <View style={styles.content}>
            <Text style={styles.contentText}>위도</Text>
            <Text style={styles.contentText}>{lastPosition.latitude.toFixed(5)}</Text>
          </View>
        </View>
      </View>
      <View style={styles.infoView}>
        ...
        <View style={{ minWidth: '50%' }}>
          <View style={styles.content}>
            <Text style={styles.contentText}>경도</Text>
            <Text style={styles.contentText}>{region.longitude.toFixed(5)}</Text>
          </View>
          <View style={styles.content}>
            <Text style={styles.contentText}>위도</Text>
